...
export const DetailWork = () => {
    return (
        <>
            ...
            <section className="section">
                <div className="w-layout-blockcontainer container padding-4-5rem w-container">
                    <div className="works-title-grid">
                        <div className="flex-title slide-from-left-animation">
                            <h5>works</h5>
                            <h3 className="caps w-dyn-bind-empty"></h3>
                            <p className="works-description w-dyn-bind-empty"></p>
                        </div>
                        <div className="works-grid slide-from-right-animation">
                            <div id="w-node-_47be6afe-e1ef-433a-40f8-6c8926cacc9a-3e33684a" className="works-details-info">
                                <h5>Client • </h5>
                                <p id="w-node-_47be6afe-e1ef-433a-40f8-6c8926cacc9d-3e33684a" className="w-dyn-bind-empty"></p>
                            </div>
                            <div id="w-node-_47be6afe-e1ef-433a-40f8-6c8926cacc9f-3e33684a" className="works-details-info">
                                <h5>Category • </h5>
                                <p id="w-node-_47be6afe-e1ef-433a-40f8-6c8926cacca2-3e33684a" className="w-dyn-bind-empty"></p>
                            </div>
                            <div id="w-node-_47be6afe-e1ef-433a-40f8-6c8926cacca4-3e33684a" className="works-details-info">
                                <h5>Date • </h5>
                                <p id="w-node-_47be6afe-e1ef-433a-40f8-6c8926cacca7-3e33684a" className="w-dyn-bind-empty"></p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="section">
                <div className="w-layout-blockcontainer container padding-4-5rem w-container">
                    <div className="image-wrapper slide-up-animation">
                        <img loading="eager" height="" alt="" src="" className="image-parallax-curve w-dyn-bind-empty" />
                        <div data-w-id="575c569b-04f8-535b-a62d-6ecd1d1e4795" className="trigger"></div>
                    </div>
                </div>
            </section>
            <section className="section">
                <div className="w-layout-blockcontainer container padding-4-5rem w-container">
                    ...
                    <div className="works-details">
                        <div className="works-rich-text slide-up-animation w-dyn-bind-empty w-richtext"></div>
                    </div>
                </div>
            </section>
            <section className="section">
                <div className="w-layout-blockcontainer container padding-4-5rem w-container">
                    ...
                    <div className="slide-up-animation w-dyn-list">
                        <div role="list" className="works-grid-thirds w-dyn-items">
                    ...
                    <div data-w-id="fa36639f-bc34-8f1a-4024-d088998077f8" className="footer-top">
                        <div className="footer-block">
                            <a href="index.html" className="footer-logo-link-wrapper w-nav-brand">
                                <img width="Auto" height="Auto" alt="logo" src="images/iDesigner.png" loading="eager" srcSet="images/iDesigner-p-500.png 500w, images/iDesigner.png 715w" sizes="(max-width: 479px) 99px, (max-width: 991px) 66px, 5vw" className="footer-logo" /></a>
