    ...
    <div className="w-layout-blockcontainer container overflow w-container">
      ...
      <div className="utilities-flex">
        ...
        <div className="utilities-wrapper slide-from-right-animation">
          ...
          <p>The font family used in this template is <a href="https://fonts.google.com/specimen/Inter?query=in" target="_blank">Inter</a> open source font from Google Fonts. You can see the source licenses at the links below:</p>
          <div className="space-1rem"></div>
          <ul role="list">
            <li>
              <a href="https://fonts.google.com/specimen/Inter/about?query=inter" target="_blank">Inter</a>
            </li>
          </ul>
          ...
          <div className="space-1rem"></div>
          <p>All images and icons used in the template are licensed for personal and commercial use. If you want to use some specific image, you can check the licenses and download the images for free from <a href="https://app.spline.design/community/file/615b9422-9985-43f6-8593-d7d7bc3b0be1" target="_blank">Spline Community,</a>
            <a href="https://unsplash.com/" target="_blank">Unsplash, </a>
            <a href="https://www.ls.graphics/" target="_blank">ls.graphics.</a>
          </p>
          <div className="space-1rem"></div>
          <div className="utilities-grid-thirds">
            <a href="https://unsplash.com/license" target="_blank" className="utilities-gallery-image-wrapper w-inline-block"><img sizes="(max-width: 479px) 40vw, (max-width: 767px) 28vw, (max-width: 991px) 29vw, (max-width: 7200px) 20vw, 1440px" srcSet="../images/ParallaxImage-p-500.jpg 500w, ../images/ParallaxImage-p-800.jpg 800w, ../images/ParallaxImage-p-1080.jpg 1080w, ../images/ParallaxImage.jpg 1440w" alt="Parallax image" src="../images/ParallaxImage.jpg" loading="lazy"/></a>
            <a href="https://www.ls.graphics/license" target="_blank" className="utilities-gallery-image-wrapper w-inline-block"><img sizes="(max-width: 479px) 40vw, (max-width: 767px) 28vw, (max-width: 991px) 29vw, (max-width: 7200px) 20vw, 1440px" srcSet="../images/Poster_Mockup-p-500.jpg 500w, ../images/Poster_Mockup-p-800.jpg 800w, ../images/Poster_Mockup-p-1080.jpg 1080w, ../images/Poster_Mockup.jpg 1440w" alt="poster" src="../images/Poster_Mockup.jpg" loading="lazy"/></a>
          </div>
